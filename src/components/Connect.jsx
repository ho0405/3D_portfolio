...
import { FaInstagram, FaGithub, FaLinkedin } from 'react-icons/fa'; // Import React Icons
      ...
      <div className="mt-7 flex justify-between items-center gap-1">
        ...
        <a href={socialLink} target="_blank" rel="noopener noreferrer">
          {socialLink.includes('instagram') ? (
            <FaInstagram className="w-10 h-10 text-white cursor-pointer" />
          ) : socialLink.includes('github') ? (
            <FaGithub className="w-10 h-10 text-white cursor-pointer" />
          ) : socialLink.includes('linkedin') ? (
            <FaLinkedin className="w-10 h-10 text-white cursor-pointer" />
          ) : (
